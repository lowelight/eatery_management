...
values (1, 30,"Tuesday","2023-08-08","2023-08-08",50,50);


insert into Vouchers (eatery_id,discount_percentage,weekday,start_,end_,set_number,number) 
values (2, 20,"Monday","2023-08-07","2023-08-07",20,19);

insert into Vouchers (eatery_id,discount_percentage,start_,end_,set_number,number) 
values (2, 50,"2023-08-04","2023-08-18",30,30);

insert into Vouchers (eatery_id,discount_percentage,start_,end_,set_number,number) 
values (1, 50,"2023-08-04","2023-08-18",30,29);
...
values (1, 1,"qwer12","2023-08-04","2023-08-18");

insert into has_vouchers (voucher_id,customer_id,code,start_,end_) 
values (2, 1,"qwerdf","2023-08-07","2023-08-07");
